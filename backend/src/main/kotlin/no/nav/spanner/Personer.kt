...
interface Personer {
    ...
    suspend fun speilperson(
        call: ApplicationCall,
        fnr: String,
    )

    suspend fun spiskammersetPerioder(
        call: ApplicationCall,
        fnr: String,
        fom: LocalDate,
        tom: LocalDate,
    ...
    suspend fun spiskammersetOpplysninger(
        call: ApplicationCall,
        behandlingId: UUID,
        opplysninger: List<String>,
    )

    suspend fun spiskammersetHentAlt(
        call: ApplicationCall,
        request: HentAltSpiskammersetRequest,
    )

    suspend fun hendelse(
        call: ApplicationCall,
        meldingsreferanse: String,
    )

    suspend fun sendteMeldinger(
        call: ApplicationCall,
        meldingsreferanse: String,
    )
}
...
class Spleis(
    ...
    override suspend fun spiskammersetOpplysninger(
        ...
        val accessToken = call.bearerToken ?: return call.respond(Unauthorized)
        val url =
            URLBuilder(spiskammersetBaseUrl)
                .apply {
    ...
    private suspend fun aktivitetslogg(
        accessToken: String,
        ident: String,
        callId: String,
    ): String? {
    ...
    override suspend fun sendteMeldinger(
        call: ApplicationCall,
        meldingsreferanse: String,
    ) {
        val accessToken = call.bearerToken ?: return call.respond(Unauthorized)
...
data class ClientIdWithName(
    ...
    fun token(
        ...
        return azureAD
            .onBehalfOfToken(scope, accessToken)
            .also {
